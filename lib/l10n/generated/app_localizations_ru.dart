...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get proxiesTab => 'Серверы';

  @override
  String get proxiesTitle => 'Серверы';
  ...
  String get aboutSectionSubtitle =>
      'Версия клиента, HydraCore, безопасность и служебная информация.';
  ...
  String get aboutDevelopedBy =>
      'HydraBox — subscription-first клиент для self-hosted VPN-стека Hydra.';
  ...
  String get legalGateSubtitle =>
      'Чтобы продолжить, прочитайте и примите соглашение и политику конфиденциальности.';
