 ...
 */
internal class HydraBoxForegroundNotification(
    private val service: Service,
    private val notificationId: Int,
) {
    companion object {
        const val CHANNEL_ID = "hydrabox_vpn_status"
        const val ACTION_REFRESH_LATENCY = "io.hydrabox.client.singbox.REFRESH_LATENCY"
