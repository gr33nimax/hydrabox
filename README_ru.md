...
- MeowTeam: YamixDEV отвечает за клиент, [dudosxdev](https://github.com/dudosxdev) — за модифицированное [ядро sing-box](https://github.com/dudosxdev/sing-box).
