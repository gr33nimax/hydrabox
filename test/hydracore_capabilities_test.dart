...
void main() {
  test('strictly parses the pinned HydraCore API v2 capability shape', () {
    ...
    expect(capabilities.coreVersion, 'v1.13.16-extended-hydracore.11-debug.49');
  ...
  test(
    ...
    () {
      final capabilities = HydraCoreCapabilities.parseStrict(
        File(
          'test/fixtures/hydracore_client_capabilities_v1.13.16-extended-hydracore.11-debug.49.json',
        ).readAsStringSync(),
      );
...
Map<String, dynamic> _capabilities() => {
  ...
  'identity': {
    ...
    'core_name': 'HydraCore',
    'core_version': 'v1.13.16-extended-hydracore.11-debug.49',
    'role': 'client',
  },
  'features': {
